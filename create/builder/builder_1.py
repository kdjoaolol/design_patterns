...
basicamente uma projeto que cria objetos mais complexos, no python nao precisa
pois temos o class A:
                  def __init__(self, firstname=None)
                        self.firstname = firstname <---
                        
                        Dai quando for chamar a classe ja passa os parametros
                        do objeto, nao precisando chamar metodos para criacao do mesmo
"""
...
class UserDirector:
      ...
      def with_age(self, firstname, lastname, age): # encadeiamento de motodos
...
if __name__ == '__main__':
      ...
      user1 = user_director.with_age('Joao', 'Victor', 21)
      user2 = user_director.with_address('Maria','Souza', 'Alto da 15')
      print(user1)
      print(user2)